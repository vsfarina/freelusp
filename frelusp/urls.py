...
from meu_app.views import criar_servico, listar_servicos, excluir_servico
...
urlpatterns = [
    ...
    path('servicos/excluir/<int:servico_id>/', excluir_servico, name='excluir_servico'),
    path('servicos-da-empresa/', views.listar_servicos, name='servicosDaEmpresa'),
